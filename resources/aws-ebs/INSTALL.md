...
1. Download the `ebs-deploy.yaml` file.
...
```
4. Replace the content of the  `credentials` field of the  `yace-ebs-credentials` secret  with the one that you have copied.
